...
import com.example.quizapp.MainActivity.Companion.QUIZ
import com.example.quizapp.MainActivity.Companion.QUIZ_SET
import com.example.quizapp.MainActivity.Companion.TITLE
...
//Aktywnosc quizu - bez przechodzenia do innych okien, aż do podsumowania

class QuizActivity: BaseActivity() {

    //Dodałeś zabezpieczenie przed pustym stringiem
    ...
    //Odliczanie do końca czasu na odpowiedź
    var countDown = getCountDownTimer()


    //Przygotowywanie następnego pytania
    ...
    return View.OnClickListener {
        ...
        resetNextTimer()
        prepareNext.start()
        //odpalic odliczanie - napelanianie zegara
    }
        //TODO sprawdza czy odp prawidłowa i coś robi
...
if(currentNumber > 0){
 val anim = AlphaAnimation(1.0f,0.0f)
    ...
    private fun getPrepareNextTimer(): CountDownTimer{
        return object : CountDownTimer(prepareNextRemain, 100) {
            override fun onFinish() {
                resetCountDownTimer()
    ...
    companion object{
        ...
        const val SUCCESS_SUMMARY = " SUCCES_SUMMMARY"
